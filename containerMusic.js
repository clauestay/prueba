...
function loadSong(song) {
  ...
  if (cancionesMax.includes(song)) {
    cover.src = "images/DiscoMax.png";
  }

  if (cancionesLore.includes(song)) {
    cover.src = "images/DiscoYo.png";
  }

  if (cancionesMaxLore.includes(song)) {
    cover.src = "images/DiscoMezcla.png";
  }
