...
var isMobile = /Android|iPhone|iPad|iPod|IEMobile|Opera Mini/i.test(
  navigator.userAgent
);
var init = false;
...
function overrideOptions(e) {
  for (var t in e) options[t] = e[t];
}
...
function addRules(e) {
  var t;
  for (t = 0; t < cssRules.length; t++) e.insertRule(cssRules[t], 0);
  for (
    e.insertRule(
...
function createElements() {
  ...
  e.setAttribute("id", "pleaserotate-backdrop"),
    t.setAttribute("id", "pleaserotate-container"),
    n.setAttribute("id", "pleaserotate-message"),
    e.appendChild(t),
    null !== options.iconNode
      ? t.appendChild(options.iconNode)
      : t.appendChild(createPhoneSVG()),
    t.appendChild(n),
    n.appendChild(document.createTextNode(options.message)),
    o.appendChild(document.createTextNode(options.subMessage)),
    n.appendChild(o),
...
function createPhoneSVG() {
  ...
  e.setAttributeNS(
    ...
    e.setAttribute("id", "pleaserotate-graphic"),
    e.setAttribute("viewBox", "0 0 250 250");
  var t = document.createElementNS("http://www.w3.org/2000/svg", "g");
  t.setAttribute("id", "pleaserotate-graphic-path"),
    options.forcePortrait && t.setAttribute("transform", "rotate(-90 125 125)");
...
function setVisibility(e) {
  var t = document.getElementById("pleaserotate-backdrop");
  e ? t && (t.style.display = "block") : t && (t.style.display = "none");
}
function orientationChanged() {
  var e,
    t =
      ...
      (!currentOrientation && options.forcePortrait);
  t
    ? ((e = options.onShow()), setBodyClass("showing"))
    : ((e = options.onHide()), setBodyClass("hiding")),
    (void 0 === e || e) && ((PleaseRotate.Showing = t), setVisibility(t));
}
function isPortrait() {
